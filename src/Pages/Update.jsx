...
const ChatBar = ({ sponsorName }) => {
    ...
    return (
        <div className="bg-gray-200 h-full w-1/4">
            ...
            <ul className="mt-4 ml-4"> {/* Shifted the messages to the left */}
            ...
            {showChat && (
                <div className="mt-4 p-4 border-t border-gray-400 ml-4"> {/* Shifted the chat to the left */}
...
const ApprovedSponsors = () => {
    ...
    return (
        <>
        <div className='flex border border-red-500 w-96 h-96'></div>
